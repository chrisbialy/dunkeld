...
<!--\\\\\\\\\\\\\\\\\\\\\///////////////////////////////\\\\\\\\\\\\\\\\/////////\\\\\\ -->
  ...
  <div class="container-spacy   ">
   <div class="row ">
	  <h3 class="h4_user_inactive">Inactive Account</h3>
		<h4 class="h4_user_inactive">We are sorry <?php echo $username; ?> but your account has been suspended</h4>
		<h4 class="h4_user_inactive">Please contact web admin</h4>
