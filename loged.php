...
<html>
 <head>
  ...
  <div class="container-spacy   ">
   <div class="row ">
	<h3 class="h4_user_inactive">My Account</h3>
	<!--\\\\\\\\\\\\\\\\\\\\\///////////////////////////////\\\\\\\\\\\\\\\\/////////\\\\\\ -->		
		<div>
	<nav>
	<ul>
		...
		?>
		<li><a href="register.html" class="button">Register New Account</a></li>
		<br>
		<?php } else { 
				if($currentuser['userlevel']==1) { ?>
		<li><a href="inactive.php" class="button">Account Panel<a></li>
		<br>
				<?php } else { ?>
...
<fieldset>
	...
	<label for="username"></label><input type="text" placeholder="Username" name="username" id="username" size="10" required /><br />
	<br>
	<label for="userpass"></label><input type="password" placeholder="Password" name="userpass" id="userpass" size="10" required /><br />
	<br>
	<br>
...
<?php } else { ?>
<h4 class="h4_user_inactive">Welcome back <?php echo $currentuser['username']; ?>!</h4>
<?php } ?>
