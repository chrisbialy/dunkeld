...
<!--\\\\\\\\\\\\\\\\\\\\\///////////////////////////////\\\\\\\\\\\\\\\\/////////\\\\\\ -->
  ...
  <div class="container-spacy   ">
   <div class="row ">
	  <h3 class="h4_user_inactive">Welcome to Account Panel <?php echo $username; ?></h3>
	  
	<ul>
		<li><a href="loged.php" class="button">My Account</a></li>
		<br>
		<li><a href="edit_user.php" class="button">Edit Your Details</a></li>
		<br>
		<li><a href="delete_user.php" class="button">Delete Your Account</a></li>
		<br>
		<?php if($currentuser['userlevel']>2) { ?>
		<br>
		<li><a href="admin_user_select2.php" class="button">Edit User Details</a></li>
		<br>
		<?php } ?>
